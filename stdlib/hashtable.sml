...
structure HashTable : sig
    ...
    val set : ('a, 'b) hash_table -> ('a * 'b) -> unit
    val get : ('a, 'b) hash_table -> 'a -> 'b
    val pop : ('a, 'b) hash_table -> 'a -> 'b
    val contains : ('a, 'b) hash_table -> 'a -> bool
    val len : ('a, 'b) hash_table ->  int

    val toList : ('a, 'b) hash_table -> ('a * 'b) list
    val fromList : ('a * 'b) list -> ('a, 'b) hash_table

    val app : ('a, 'b) hash_table -> (('a * 'b) -> unit) -> unit
    val map : ('a, 'b) hash_table -> (('a * 'b) -> 'c) -> ('a, 'c) hash_table
    val filter : ('a, 'b) hash_table -> (('a * 'b) -> bool) -> unit
